      ...
      <div className="footer__container grid">
        <div className="footer__content">
          <a href="index.html" className="footer__logo">
            <img src="./src/assets/img/logo.svg" alt="" className="footer__logo-img" />
          </a>
          ...
          <div className="footer__social">
            ...
            <div className="footer__links flex">
              <a href="#">
                <img
                  src="./src/assets/img/icon-facebook.svg"
                  alt=""
              ...
              <a href="#">
                <img
                  src="./src/assets/img/icon-twitter.svg"
                  alt=""
                  className="footer__social-icon"
                />
              </a>
              <a href="#">
                <img
                  src="./src/assets/img/icon-instagram.svg"
                  alt=""
                  className="footer__social-icon"
                />
              </a>
              <a href="#">
                <img
                  src="./src/assets/img/icon-pinterest.svg"
                  alt=""
                  className="footer__social-icon"
                />
              </a>
              <a href="#">
                <img
                  src="./src/assets/img/icon-youtube.svg"
                  alt=""
                  className="footer__social-icon"
                />
              </a>
        ...
        <div className="footer__content">
          ...
          <img
            src="./src/assets/img/payment-method.png"
            alt=""
