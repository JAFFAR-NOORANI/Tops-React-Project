      ...
      <aside className="sidebar-nav-wrapper">
        ...
        <div className="promo-box">
          <div className="promo-icon">
            <img
              className="mx-auto"
              src="/src/assets/images/logo/logo-icon-big.svg"
              alt="Logo"
            />
          </div>
                    ...
                    >
                      <li>
                        <a href="#0">
                          <div className="image">
                            <img
                              src="/src/assets/images/lead/lead-6.png"
                              alt=""
                            />
                          </div>
                      ...
                      <li>
                        <a href="#0">
                          <div className="image">
                            <img
                              src="/src/assets/images/lead/lead-1.png"
                              alt=""
                            />
                          </div>
                          <div className="content">
                    ...
                    >
                      <li>
                        <a href="#0">
                          <div className="image">
                            <img
                              src="/src/assets/images/lead/lead-5.png"
                              alt=""
                            />
                          </div>
                          <div className="content">
                      ...
                      <li>
                        <a href="#0">
                          <div className="image">
                            <img
                              src="/src/assets/images/lead/lead-3.png"
                              alt=""
                            />
                          </div>
                          <div className="content">
                      ...
                      <li>
                        <a href="#0">
                          <div className="image">
                            <img
                              src="/src/assets/images/lead/lead-2.png"
                              alt=""
                            />
                          </div>
                          <div className="content">
                    ...
                    >
                      <div className="profile-info">
                        <div className="info">
                          <div className="image">
                            <img
                              src="/src/assets/images/profile/profile-image.png"
                              alt=""
                            />
                          </div>
                          <div>
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="product">
                              <div className="image">
                                <img
                                  src="/src/assets/images/products/product-mini-1.jpg"
                                  alt=""
                                />
                              </div>
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="product">
                              <div className="image">
                                <img
                                  src="/src/assets/images/products/product-mini-2.jpg"
                                  alt=""
                                />
                              </div>
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="product">
                              <div className="image">
                                <img
                                  src="/src/assets/images/products/product-mini-3.jpg"
                                  alt=""
                                />
                              </div>
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="product">
                              <div className="image">
                                <img
                                  src="/src/assets/images/products/product-mini-4.jpg"
                                  alt=""
                                />
                              </div>
