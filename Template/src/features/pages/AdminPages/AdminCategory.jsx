   ...
   <>
      ...
      <nav className="sidebar-nav">
        <ul>
          ...
          <li className="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_5" className="collapsed show dropdown-nav">
              <li>
                <a href="form-elements.html" className="active"> Form Elements </a>
              </li>
            </ul>
          </li>
          <li className="nav-item">
      ...
      <div className="promo-box">
        <div className="promo-icon">
          <img className="mx-auto" src="/src/assets/images/logo/logo-icon-big.svg" alt="Logo"/>
        </div>
                ...
                <div className="breadcrumb-wrapper">
                  <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                      ...
                      <li className="breadcrumb-item"><a href="#0">Forms</a></li>
              ...
              <div className="col-lg-6">
                ...
                <div className="card-style mb-30">
                  ...
                  <div className="form-check form-switch toggle-switch mb-30">
                    ...
                    <label className="form-check-label" for="toggleSwitch1">Default switch checkbox input</label>
                  </div>
                  <div className="form-check form-switch toggle-switch">
                    <input className="form-check-input" type="checkbox" id="toggleSwitch2" checked />
                    <label className="form-check-label" for="toggleSwitch2">Default switch checkbox input</label>
                  </div>
                </div>
              ...
              <div className="col-lg-6">
                ...
                <div className="card-style mb-30">
                  ...
                  <div className="form-check checkbox-style mb-20">
                    ...
                    <label className="form-check-label" for="checkbox-2">
                  ...
                  <div className="form-check checkbox-style checkbox-success mb-20">
                    ...
                    <label className="form-check-label" for="checkbox-3">
                  ...
                  <div className="form-check checkbox-style checkbox-warning mb-20">
                    ...
                    <label className="form-check-label" for="checkbox-4">
                  ...
                  <div className="form-check checkbox-style checkbox-danger mb-20">
                    ...
                    <label className="form-check-label" for="checkbox-5">
                ...
                <div className="card-style mb-30">
                  ...
                  <div className="form-check radio-style mb-20">
                    <input className="form-check-input" type="radio" value="" id="radio-1" />
                    <label className="form-check-label" for="radio-1">
                      Default Radio</label>
                  </div>
                  {/* <!-- end radio --> */}
                  <div className="form-check radio-style mb-20">
                    <input className="form-check-input" type="radio" value="" id="radio-2" disabled />
                    <label className="form-check-label" for="radio-2">
                      Disabled Radio</label>
                  </div>
                  {/* <!-- end radio --> */}
                  <div className="form-check radio-style radio-success mb-20">
                    <input className="form-check-input" type="radio" value="" id="radio-3" />
                    <label className="form-check-label" for="radio-3">
                      Success Radio</label>
                  </div>
                  {/* <!-- end radio --> */}
                  <div className="form-check radio-style radio-warning mb-20">
                    <input className="form-check-input" type="radio" value="" id="radio-4" />
                    <label className="form-check-label" for="radio-4">
                      Warning Radio</label>
                  </div>
                  {/* <!-- end radio --> */}
                  <div className="form-check radio-style radio-danger mb-20">
                    <input className="form-check-input" type="radio" value="" id="radio-5" />
                    <label className="form-check-label" for="radio-5">
                      Danger Radio</label>
                  </div>
                  {/* <!-- end radio --> */}
                </div>
